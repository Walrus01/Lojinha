...
<body class="color-primary">
    ...
    <form action="ControleClientes.php" method="GET" name="FormCliente" id="FormCliente">
            ...
            <div class="color-secondary card px-4 py-5 border border-light p-2 rounded-3" data-bs-theme="dark">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input class="color-primary form-control border border-light p-2" type="number" name="CodCliente" id="CodCliente" min=1 max=99999 step="0" placeholder="Código do Cliente" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="input-group"> <input class="color-primary form-control border border-light p-2" type="number" name="CelCliente" id="CelCliente" min=100000000 max=999999999 step="0" placeholder="Celular"> </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
