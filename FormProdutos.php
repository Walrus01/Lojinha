...
<body class="color-primary">
    ...
    <form action="ControleProdutos.php" method="GET" name="FormProdutos" id="FormProdutos">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="input-group">
                                    <input class="color-primary form-control border border-light p-2" type="number" name="ValProduto" id="ValProduto" min=1 max=999 step="0.01" placeholder="Valor">
                                </div>
                            </div>
                        </div>
                    </div>
